package com.nickromito.brovalon.model.test;


import java.util.ArrayList;
import java.util.List;

import com.nickromito.brovalon.model.*;
...
public class TestModel extends TestCase {
	...
	public void testJoinGame()
	{
		...
		myPlayer.setCom( Com.ComType.LOCAL );
	...
	public void testStartGame()
	{
		...
		for( int i=0; i<5; i++ )
		{
			...
			playerList.get(i).setCom( Com.ComType.LOCAL );
